			...
			if(!$form.attr('action')) // Check form doesnt have action attribute
			{
				...
				$.ajax({
		    		...
		    		success: function() // Success
		 			{  
						if($form.is('[data-success_msg]')) // Show Success Message
						{
							$form.append("<div id='form-alert'><div class='alert alert-success'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>"+$form.attr('data-success_msg')+"</strong></div></div>");
						}
						else // Re-Direct
						{
